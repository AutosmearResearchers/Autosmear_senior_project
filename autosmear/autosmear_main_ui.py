...
class MainWidget(QMainWindow):
    ...
    def create_command(self):
        ...
        if self.feature_tab_widget.currentIndex() == 0:
            ...
            interval = self.infoinput.interval_spinbox.value(),
            custom_frame = self.infoinput.custom_smear_spinbox.value(),
    ...
    def radiobutton_selection(self):
        ...
        """
        selection_number = 3
        if self.infoinput.autosmear_radiobutton.isChecked() is True:
            selection_number = 1
        elif self.infoinput.interval_radiobutton.isChecked() is True:
            selection_number = 2
...
class InfoInput(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.autosmear_layout = QHBoxLayout()
        self.autosmear_layout.setContentsMargins(0,5,0,5)
        self.autosmear_radiobutton = QRadioButton("Default autosmear:")
        self.autosmear_radiobutton.setChecked(True)

        self.autosmear_layout.addWidget(self.autosmear_radiobutton)

        self.interval_layout = QHBoxLayout()
        self.interval_radiobutton = QRadioButton("Create interval:")
        ...
        self.interval_layout.addWidget(self.interval_radiobutton)
        ...
        self.custom_smear_radiobutton = QRadioButton("Create custom smear frame:")
        ...
        self.custom_smear_layout.addWidget(self.custom_smear_radiobutton)
        ...
        self.keyframe_confining_layout.addLayout(self.autosmear_layout)
